...
namespace BookStore.WebApi.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        {
            var books = await _bookService.GetAll(HttpContext.RequestAborted);
        ...
        {
            var books = await _bookService.GetBooksByCategory(categoryId, HttpContext.RequestAborted);
        ...
        public async Task<IActionResult> Add([FromBody]BookAddDto bookDto)
        {
            ...
            var bookResult = await _bookService.Add(book, HttpContext.RequestAborted);
        ...
        public async Task<IActionResult> Update([FromBody]BookEditDto bookDto)
        {
            ...
            var bookResult = await _bookService.Update(_mapper.Map<Book>(bookDto), HttpContext.RequestAborted);
            if (bookResult == null) return BadRequest();
        ...
        {
            var books = _mapper.Map<List<Book>>(await _bookService.Search(bookName, HttpContext.RequestAborted));
        ...
        {
            var books = _mapper.Map<List<Book>>(await _bookService.SearchBookWithCategory(searchedValue, HttpContext.RequestAborted));
